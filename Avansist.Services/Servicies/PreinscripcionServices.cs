...
namespace Avansist.Services.Servicies
{
    public class PreinscripcionServices : IPreinscripcionServices
    {
        ...
        public async Task EditarBeneficiario(Preinscripcion preinscripcion)
        {
        ...
        public async Task GuardarBeneficiario(Preinscripcion preinscripcion)
        {
            //Preinscripcion preinscripcion = new()
            //{
            //    PreinscripcionId = preinscripcionDto.PreinscripcionId,
        ...
        public async Task<Preinscripcion> ObtenerBeneficiarioPorId(int id)
        {
        ...
        public async Task GuardarMatricula(Preinscripcion preinscripcion)
        {
            //Preinscripcion preinscripcion = new()
            //{
            //    PreinscripcionId = preinscripcionDto.PreinscripcionId,
        ...
        public async Task EditarMatricula(Preinscripcion preinscripcion)
        {
            //Preinscripcion preinscripcion = new()
            //{
            //    PreinscripcionId = preinscripcionDto.PreinscripcionId,
